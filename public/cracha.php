...
<script src="https://cdn.jsdelivr.net/npm/qrcodejs@1.0.0/qrcode.min.js"></script><script>new QRCode(document.querySelector('#public-qrcode'),{text:<?=json_encode($student['qr_token'])?>,width:250,height:250,correctLevel:QRCode.CorrectLevel.H});</script>
<?php layout_footer();
