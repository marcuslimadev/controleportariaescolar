...
$config = ['app_name'=>'Porta Aberta Escolar','locale'=>'pt','base_url'=>$opts['base-url'] ?? '','db'=>['host'=>$env['DB_HOST'],'port'=>$env['DB_PORT'],'name'=>$env['DB_DATABASE'],'user'=>$env['DB_USERNAME'],'pass'=>$env['DB_PASSWORD']]];
