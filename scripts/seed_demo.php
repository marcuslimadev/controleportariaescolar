...
try {
    ...
    $q->execute(['Agente de Portaria', 'portaria@scp.local', password_hash('Portaria@2026!Teste', PASSWORD_DEFAULT)]);
    ...
    $q->execute(['Responsável Teste','11144477735','responsavel@scp.local','11999990000',password_hash('Responsavel@2026!Teste', PASSWORD_DEFAULT)]);
